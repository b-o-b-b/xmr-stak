...
This fork is for the new CN-Turtle algorithm currently used by DeroGold. Please note that only the source is currently available. Binaries will follow soon.
